...
public class OrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        OrderProductDto orderProductDto = mapper.readValue(ServletUtilsReadJson.readJson(req.getReader()), OrderProductDto.class);
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        OrderDto orderDtoFromJson = mapper.readValue(ServletUtilsReadJson.readJson(req.getReader()), OrderDto.class);
